...
export default function FeedBackApp() {
    ...
    const schemaForm = Yup.object().shape({
        selectedStars: Yup.number().min(1, "Clique na estrela para avaliar").required("Clique na estrela para avaliarr")
    })
    ...
    return (
        <TouchableWithoutFeedback onPress={() => Keyboard.dismiss()}>
            <View style={style.container}>
                ...
                <View style={[style.containerOptions, errors.selectedStars ? style.containerOptionsError : null]}>
                    {[0, 1, 2, 3, 4].map((index) => (
                        <TouchableOpacity
                            key={index}
