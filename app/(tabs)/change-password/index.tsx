...
export default function ChangePassword() {
    ...
    const validateForm = async () => {
        try {
            setErrors({});
            await schemaForm.validate({ actualPassword, newPassword, confirNewPassword }, { abortEarly: false });
            console.log("Formulário válido", { actualPassword, newPassword, confirNewPassword });
            ...
            <View style={style.container}>
                ...
                <View style={style.alterContainer}>
                    <View style={style.alterInputContainer}>
                        <View style={[style.dataInput, errors.actualPassword ? style.dataInputError : null]}>
                            <TextInput
                        ...
                        <View style={[style.dataInput, errors.newPassword ? style.dataInputError : null]}>
                            <TextInput
                        ...
                        <View style={[style.dataInput, errors.confirNewPassword ? style.dataInputError : null]}>
                            <TextInput
